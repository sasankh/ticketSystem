...
ticket.config(function($routeProvider, $locationProvider){
	...
	.when('/Ticket/ticketSetting',
	{
		controller:'ticketSettingController',
		templateUrl:'views/Ticket/ticketSetting.html'
	})
	.when('/Ticket/disableTicket',
	{
		controller:'disableTicketListController',
		templateUrl:'views/Ticket/disabledTickets.html'
	})
	//Email routes
	.when('/Email/email',
	{
...
//401 intercepter
ticket.config(['$httpProvider',function($httpProvider) {
